...
import { Aperture, Database, Globe, Rocket, Wallet, Chat } from 'phosphor-react-native';
...
import { ChatScreen } from 'screens/Home/Chats'
...
const chatsTabbarIcon = ({ color }: tabbarIconColor) => {
  return <Chat size={24} color={color} weight={'fill'} />;
};
