...
export const Settings = ({ navigation: drawerNavigation }: DrawerContentComponentProps) => {
  ...
  return (
    <SubScreenContainer
      ...
      icon={<SVGImages.Logo width={28} height={28} />}
      rightIcon={X}
      ...
      <>
        ...
        <Text
          ...
          // style={versionAppStyle}>{`SubWallet v${VersionNumber.appVersion} (${VersionNumber.buildVersion})`}
          style={versionAppStyle}>{`MY Identity`}
        </Text>
      </>
    </SubScreenContainer>
  );
